...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'me_postphoto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['me.Post'])),
            ('text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('panorama', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('private', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('photoRight', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('panoramaRight', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('privateRight', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'me', ['PostPhoto'])


    def backwards(self, orm):
        # Deleting model 'PostPhoto'
        db.delete_table(u'me_postphoto')
    ...
    models = {
        ...
        u'me.postphoto': {
            'Meta': {'object_name': 'PostPhoto'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'panorama': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'panoramaRight': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'photoRight': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['me.Post']"}),
            'private': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'privateRight': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
