...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'me_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('headImage', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
        ...
        db.send_create_signal(u'me', ['Category'])

        # Deleting field 'Post.site'
        db.delete_column(u'me_post', 'site_id')

        # Adding field 'Post.category'
        db.add_column(u'me_post', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['me.Category']),
                      keep_default=False)


        # Changing field 'Post.created'
        db.alter_column(u'me_post', 'created', self.gf('django.db.models.fields.DateTimeField')())
        # Adding field 'Tag.category'
        db.add_column(u'me_tag', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['me.Category']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'me_category')

        # Adding field 'Post.site'
        db.add_column(u'me_post', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Deleting field 'Post.category'
        db.delete_column(u'me_post', 'category_id')


        # Changing field 'Post.created'
        db.alter_column(u'me_post', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Deleting field 'Tag.category'
        db.delete_column(u'me_tag', 'category_id')
