...
from project.registration.admin import RegistrationAdmin
from project.registration.forms import RegistrationForm
from project.registration.backends.default.views import RegistrationView
